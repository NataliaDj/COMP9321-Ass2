...
<table style="width:50%">
	...
	<tr>
		<td><b>Email:</b></td>
		<td><c:out value="${userDTO.email}"/><td>
	</tr>
	<tr>
		<td><b>First Name:</b></td>
		<td><c:out value="${userDTO.firstName}"/><td>
	</tr>
	<tr>
	<td>	<b>Last Name:</b></td>
		<td><c:out value="${userDTO.lastName}"/><td>
	</tr>
	<tr>
		<td><b>Birth Year:</b></td>
		<td><c:out value="${userDTO.birthYear}"/><td>
	</tr>
	<tr>
		<td><b>Address:</b></td>
	...
	<tr>
		...
		<td><c:out value="${userDTO.accountActivated}"/><td>
	</tr>
	<tr>
		<td><b>Account Banned:</b></td>
		<td><c:out value="${userDTO.ban}"/><td>
	</tr>
</table>
